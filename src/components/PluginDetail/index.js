...
const statusTone = {verified:'green', community:'blue', documented:'blue', testing:'yellow', conflict:'red', legacy:'yellow', research:'purple', deprecated:'red'};
