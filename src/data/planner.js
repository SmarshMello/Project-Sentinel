export const plannerProfiles = {
  ...
  paid: {label:'Paid maximum realism', description:'The personal Sentinel architecture with Nexus and unscripted NPCAI voice.', ids:['lspdfr','rage-plugin-hook','openiv','scripthookv','heap-adjuster','packfile-limit-adjuster','gameconfig','damage-tracker-framework','policing-redefined','nexus-mdt-full','nexus-dispatch','npcai','alpr-lite','eup-menu','eup-law-order','eup-serve-rescue','better-radiance']},
