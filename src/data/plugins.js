...
export const plugins = [
  {
    ...
    "note": "Official core compatibility for Legacy 3889; Sentinel full-stack retest pending.",
    "sentinelPolice": true
  },
  {
    "id": "rage-plugin-hook",
  ...
  },
  {
    ...
    "category": "Core & loaders",
    "status": "verified",
    "version": "3889-compatible official release",
  ...
  },
  {
    ...
    "impact": "Low",
    "confidence": 94,
    "description": "Accurate damage-event framework used by modern RPH plugins and the Policing Redefined ecosystem.",
    "dependencies": ["RAGE Plugin Hook"],
    "tags": ["Framework", "Damage events", "PR dependency"],
    "guide": "/guide/police/damage-tracker-framework",
    "download": "https://www.lcpdfr.com/downloads/gta5mods/scripts/",
    "note": "Install using the current package's split root/plugins layout and test before Policing Redefined.",
    "sentinelPolice": true
  },
  {
    "id": "nexus-mdt-lite",
    "name": "NexusMDT Lite",
    "shortName": "Nexus Lite",
    "category": "Police systems",
    "status": "verified",
    "version": "0.3.1",
    "developer": "NexusMDT community",
    "impact": "Low",
    "confidence": 92,
    "description": "Free modern patrol computer with records, reports, citations, radar and ALPR features.",
    "dependencies": ["LSPDFR", "RAGE Plugin Hook"],
    "tags": ["Free", "MDT", "PR integration"],
    "guide": "/guide/police/nexus-mdt-dispatch",
    "download": "https://www.nexusmdt.com/lite",
    "note": "Recommended computer for the free modern Sentinel route.",
    "sentinelPolice": true
  },
  {
    "id": "nexus-mdt-full",
    "name": "NexusMDT FULL",
    "shortName": "Nexus FULL",
    "category": "Police systems",
    "status": "verified",
    "version": "Current entitlement build",
    "developer": "NexusMDT community",
    "impact": "Low",
    "confidence": 90,
    "description": "Paid/entitlement MDT used in the personal Sentinel build for records, reports and connected patrol tools.",
    "dependencies": ["LSPDFR", "RAGE Plugin Hook", "User entitlement"],
    "tags": ["Paid", "MDT", "Full edition"],
    "guide": "/guide/police/nexus-mdt-dispatch",
    "download": "https://www.nexusmdt.com/",
    "note": "Download only from the account entitlement dashboard; FULL activation does not replace local file validation.",
    "sentinelPolice": true
  },
  {
    "id": "nexus-dispatch",
    "name": "Nexus Dispatch",
    "shortName": "Nexus Dispatch",
    "category": "Communications",
    "status": "verified",
    "version": "Current entitlement build",
    "developer": "Nexus ecosystem",
    "impact": "Low",
    "confidence": 88,
    "description": "Radio, player-status and dispatch integration used by the paid modern Sentinel branch.",
    "dependencies": ["LSPDFR", "Policing Redefined"],
    "tags": ["Paid", "Dispatch", "Voice"],
    "guide": "/guide/police/nexus-mdt-dispatch",
    "download": null,
    "note": "Use the official entitlement source and keep its PTT separate from NPCAI and MDT controls.",
    "sentinelPolice": true
  },
  {
    "id": "aidispatch",
    "name": "AIDispatch",
    "shortName": "AI Dispatch",
    "category": "Communications",
    "status": "community",
    "version": "1.0",
    "developer": "boboediting",
    "impact": "Low",
    "confidence": 84,
    "description": "Natural-language Gemini voice dispatch designed for Policing Redefined.",
    "dependencies": ["Policing Redefined 1.0.0.5", "Google Gemini API", "Microphone"],
    "tags": ["Free", "Voice dispatch", "Cloud AI"],
    "guide": "/guide/communications/free-voice-options",
    "download": "https://www.lcpdfr.com/downloads/gta5mods/scripts/",
    "note": "Install the complete package during major upgrades; test recognition separately from backend action execution.",
    "sentinelPolice": true
  },
  {
    "id": "npci",
    ...
    "status": "community",
    "version": "2.1.0.0",
    "developer": "DoubleHook",
    "impact": "Low",
    "confidence": 88,
    "description": "Free phrase-based voice interaction with pedestrians, including a Policing Redefined package.",
    "dependencies": ["Microsoft Speech Platform", "LSPDFR"],
    "tags": ["Free", "Ped voice", "Speech recognition"],
    "guide": "/guide/communications/free-voice-options",
    "download": "https://www.lcpdfr.com/downloads/gta5mods/scripts/50691-npci/",
    "note": "Install the PR edition and the required Microsoft speech runtime/language pack.",
    "sentinelPolice": true
  },
  {
    "id": "npcai",
    ...
    "status": "verified",
    "version": "3.1 paid build",
    "developer": "DoubleHook",
    "impact": "Medium",
    "confidence": 90,
    "description": "Cloud-AI-powered unscripted conversation with civilians and first responders.",
    "dependencies": ["Policing Redefined edition", "Gemini or Groq API", "Microphone", "Damage Tracker Framework"],
    "tags": ["Paid", "NPC conversation", "Cloud AI"],
    "guide": "/guide/communications/npcai-paid",
    "download": "https://www.patreon.com/cw/Doublehook",
    "note": "Personal Sentinel selection. Use a legally obtained PR-specific package and keep API credentials private.",
    "sentinelPolice": true
  },
  {
    "id": "axon-signal",
    ...
    "status": "verified",
    "version": "Current entitlement release",
    "developer": "Community project",
    "impact": "Low",
    "confidence": 82,
    "description": "Bodycam and dashcam recording-roleplay layer used as an optional paid-build enhancement.",
    "dependencies": ["RAGE Plugin Hook"],
    "tags": ["Bodycam", "Dashcam", "Optional"],
    "guide": "/guide/police/axon-signal",
    "download": null,
    "note": "Install after the full police/voice stack passes; avoid key and overlay conflicts.",
    "sentinelPolice": true
  },
  {
    "id": "stop-the-ped",
  ...
  },
  {
    ...
    "guide": "/guide/police/policing-redefined",
    "download": "https://www.lcpdfr.com/downloads/gta5mods/scripts/52191-policing-redefined/",
    "note": "Selected modern Sentinel framework. Do not combine with Stop The Ped, Ultimate Backup, or CompuLite.",
    "sentinelPolice": true
  },
  {
    "id": "reports-plus",
