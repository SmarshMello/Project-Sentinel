        ...
        <section className={styles.dependencySection}>
          <div className="container">
            ...
            <div className={styles.graphShell}>
              ...
              <div className={styles.graphConnector}/>
              <div className={styles.graphLevel}><Link className={styles.graphNode} to="/plugins/damage-tracker-framework"><span>Framework</span><strong>Damage Tracker</strong></Link><Link className={styles.graphNode} to="/plugins/policing-redefined"><span>Police system</span><strong>Policing Redefined</strong></Link><Link className={styles.graphNode} to="/plugins/nexus-mdt-full"><span>Computer</span><strong>NexusMDT</strong></Link><Link className={styles.graphNode} to="/plugins/npcai"><span>Voice AI</span><strong>NPCAI</strong></Link></div>
            </div>
